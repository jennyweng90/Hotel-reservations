    ...
    <div class="section">
      <div class="container">
        <div class="row text-left mb-5">
          <div class="col-12">
            <h1 class="font-weight-bold heading text-primary mb-4">修改公告</h>
          </div>

          <?php
    $num1=$_GET['num1'];
    $link=mysqli_connect('localhost','root','12345678','inn');
    $sql="select* from announce1 where num1='".$num1."'";
    $result=mysqli_query($link,$sql);
    if($row=mysqli_fetch_assoc($result))
    {
        $announcement1=$row['announcement1'];
    }
    
    ?>
    <form method="post" action="dblink1.php">
    <input type=hidden name="dbaction1" value="update1">
