          ...
          <div class="site-navigation">
            ...
            >
              ...
              <li class="active"><?php
                      ...
                      if($_SESSION['name']<>"")
                      {
                      echo "Hi",$_SESSION['name'],"&nbsp;<a href=登出.php>登出</a>";
                      }
                      else
                      {
                        ?>
      ...
      <div class="container">
        <div class="row justify-content-center align-items-center">
          <div class="col-lg-9 text-center mt-5">
            <h1 class="heading" data-aos="fade-up"> 訂房一覽表</h1>
        ...
        <div class="container">
            <div class="row justify-content-center text-center mb-10">
              ...
              <table class="table table-hover table-bordered" style="border-color:lightgray;">
                ...
                ?>
                <div>
                <form action="訂房一覽表.php" method="post">
                <input type=text name="searchtxt" value="<?php echo $searchtxt;?>"><input type="submit" value="search">
                </form>
                </div>
                <br>
                <div><a href="新增預約資料.php"><input type="reset" value="新增訂房資料"></a></div>
                <br>
              <script src="http://code.jquery.com/jquery.js"></script>
              <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.1.3/dist/js/bootstrap.bundle.min.js" integrity="sha384-ka7Sk0Gln4gmtz2MlQnikT1wXgYsOg+OMhuP+IlRH9sENBO0LRn5q+8nbTov4+1p" crossorigin="anonymous"></script>
              <table class="table table-hover table-bordered" style="border-color:lightgray;">
                ...
                <td><font color="white">編輯</font></td>
                </tr>  
                ...
                <?php
                    ...
                    $sql="select * from reserve where name like '%".$searchtxt."%'";
                    }
                    $result=mysqli_query($link,$sql);
                    while($row=mysqli_fetch_assoc($result))
                        {echo "<tr><td>" ,$row['name'],"</td><td>",$row['phone'],"</td><td>",
                            $row['type'],"</td><td>",$row['startdate'],"</td><td>",$row['enddate'],
                            "</td><td><a href='修改預約資料.php?name=",$row['name'],"'>[修改]</a>
                            <a href='刪除預約資料.php?name=",$row['name'],"'>[刪除]</a></tr>";
                        }
